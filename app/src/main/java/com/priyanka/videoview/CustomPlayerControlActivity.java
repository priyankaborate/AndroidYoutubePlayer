...
public class CustomPlayerControlActivity extends YouTubeBaseActivity
    ...
    public static final String API_KEY = "AIzaSyBgiGWqbQnzeGKUDKNo8RKIqBPj83U1W7Y";

    //https://www.youtube.com/watch?v=<VIDEO_ID>
    public static final String VIDEO_ID = "dmCkvtVfzVo";

    private YouTubePlayer mPlayer;

    private View mPlayButtonLayout;
    private TextView mPlayTimeTextView,mPlayStartTextView;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPlayStartTextView = (TextView) findViewById(R.id.start_time);
    ...
    YouTubePlayer.PlaybackEventListener mPlaybackEventListener = new YouTubePlayer.PlaybackEventListener() {
        ...
        public void onPlaying() {
            ...
            int time=mPlayer.getDurationMillis()/100;

            Log.d("LLLLKKK", String.valueOf(time));
    ...
    SeekBar.OnSeekBarChangeListener mVideoSeekBarChangeListener = new SeekBar.OnSeekBarChangeListener() {
        ...
        public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
            ...
            Log.d("LLLLL", String.valueOf(progress));
    ...
    private void displayCurrentTime() {
       ...
       /* String formattedTime = formatTime(mPlayer.getDurationMillis() - mPlayer.getCurrentTimeMillis());
        ...
        String formattedTime = formatTime(mPlayer.getDurationMillis() - mPlayer.getCurrentTimeMillis());
        String startTime=formatTime(mPlayer.getCurrentTimeMillis());
        String totalTime=formatTime(mPlayer.getDurationMillis());
        mPlayStartTextView.setText(startTime);
        mPlayTimeTextView.setText(totalTime);
